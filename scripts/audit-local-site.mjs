...
const htmlPages = [
  ...
  },
  {
    ...
    expectedTitle: "Chinese vs Western Astrology",
    expectedH1: "Chinese vs Western Astrology: Key Differences",
    minJsonLd: 3,
    allowNoindex: true,
    requiredLinks: [
      "/bazi",
  ...
  },
  {
    ...
    expectedTitle: "Common Misconceptions",
    expectedH1: "Common Misconceptions About Chinese Metaphysics",
    minJsonLd: 3,
    allowNoindex: true,
    requiredLinks: ["/chinese-zodiac", "/feng-shui", "/learn/resources", "/tools/bazi-calculator"],
  },
  {
    path: "/learn/which-system",
    expectedTitle: "Which Chinese Metaphysics System",
    expectedH1: "Which Chinese Metaphysics System Should You Learn?",
    minJsonLd: 3,
    allowNoindex: true,
    requiredLinks: ["/bazi", "/ziwei", "/i-ching", "/feng-shui", "/chinese-zodiac"],
  },
  {
    path: "/learn/resources",
    expectedTitle: "Chinese Metaphysics Books",
    expectedH1: "Chinese Metaphysics Books & Source Evaluation Guide",
    minJsonLd: 3,
    allowNoindex: true,
    requiredLinks: ["/bazi/what-is-bazi", "/i-ching", "/bazi/five-elements"],
  },
  {
    path: "/search?q=bazi",
